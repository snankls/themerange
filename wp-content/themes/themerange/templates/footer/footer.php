...
<footer>
    ...
    <div class="tp-footer-area tp-bg-common-black p-relative z-index-1 pt-105">
        <span class="tp-footer-pp-shape">
            <svg viewBox="0 0 388 387" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M153.543 353.042C232.437 407.657 338.974 385.855 388 360.553V0H27.4193C6.72803 31.4957 -22.2397 105.399 27.4193 152.207C77.0782 199.016 38.0944 289.787 12.3951 329.322C30.8459 309.291 81.5854 303.229 153.543 353.042Z" fill="#0D0D0D" />
            </svg>
        </span>
        <span class="tp-footer-pp-shape-2">
            <svg viewBox="0 0 388 387" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M234.457 353.042C155.563 407.657 49.0263 385.855 0 360.553V0H360.581C381.272 31.4957 410.24 105.399 360.581 152.207C310.922 199.016 349.906 289.787 375.605 329.322C357.154 309.291 306.415 303.229 234.457 353.042Z" fill="#0D0D0D" />
            </svg>
        </span>
        <img class="tp-awards-bg-shape" src="assets/img/awards/grid-shape.png" alt="">
        <div class="tp-footer-top pb-70">
            <div class="container">
        ...
        <div class="tp-footer-main pt-65 pb-15">
            <div class="container">
                <div class="row">
                ...
                <div class="col-12">
                    <div class="tp-footer-copyright text-center">
                        <p class="mb-0 tp-text-grey-2">
                            ...
                            Copyright <?php echo get_the_date('Y'); ?> <a class="tp-text-common-white hover-text-primary" href="/">ThemeRange.</a> All Right Reserves. 
                        </p>
                    </div>
                </div>
                </div>
