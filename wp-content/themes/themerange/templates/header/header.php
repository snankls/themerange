              ...
              <div class="tp-header-right d-flex align-items-center justify-content-end">
                ...
                <?php if($tr_theme_options['tr_header_enable_button']) : ?>
                  <div class="tp-header-btn tp-header-btn-spacing d-none d-md-inline-block ml-20">
                    <a href="<?php echo esc_url($btn_link); ?>" class="tp-btn-lg d-inline-block lh-0 tp-round-26 fs-15 tp-bg-common-black text-uppercase ls-0 tp-btn-switch-animation tp-text-common-white hover-text-white tp-ff-heading fw-500">
                      <span class="d-flex align-items-center justify-content-center">
                        <span class="btn-text"><?php echo wp_kses($btn_name, 'themerange'); ?></span>
                        <span class="btn-icon">
