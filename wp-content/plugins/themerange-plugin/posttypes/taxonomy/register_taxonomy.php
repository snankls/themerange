...
function tr_register_taxonomy() {
	...
	//Team Taxonomy
	$team_cat_name = !empty($avtar_theme_options['tr_team_cat_name']) ? $avtar_theme_options['tr_team_cat_name'] : __('Team Category', 'themerange');
	$team_cat_slug = !empty($avtar_theme_options['tr_team_cat_slug']) ? $avtar_theme_options['tr_team_cat_slug'] : '';
	$args = array(
		'labels' => array(
