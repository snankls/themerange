...
if( !class_exists('TR_Teams') ){
	class TR_Teams{
		...
		function register_post_type(){
			...
			$team_name = !empty($themerange_theme_options['tr_team_name']) ? $themerange_theme_options['tr_team_name'] : __('Team', 'themerange');
			
			//Post and Cat Slug
			$post_slug = get_option('tr_team_permalink');
			$team_slug = !empty($themerange_theme_options['tr_team_slug']) ? $themerange_theme_options['tr_team_slug'] : '';
