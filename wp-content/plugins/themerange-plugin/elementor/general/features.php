        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-center mb-60">
              <h2 class="tp-ff-teko tp-text-perspective fw-600 fs-70 fs-sm-60 fs-xs-42 text-uppercase tp-text-common-white lh-1"><?php echo wp_kses($settings['title'], true); ?></h2>
            </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="tp-skill-wd-bottom text-center mt-35 tp_fade_anim" data-delay=".4" data-fade-from="bottom" data-ease="bounce">
              <p class="tp-skill-wd-para fw-500 fs-18 tp-text-common-white"><?php echo wp_kses($settings['bottom_text'], true); ?>
                <a <?php echo implode(' ', $link_attr); ?> class="ml-40 d-inline-block lh-0 tp-round-26 fs-15 text-uppercase ls-0 tp-btn-switch-animation tp-text-theme-primary tp-ff-heading fw-500">
                  <span class="d-flex align-items-center justify-content-center">
                    <span class="btn-text"><?php echo wp_kses($settings['btn_name'], true); ?></span>
                    <span class="btn-icon">
