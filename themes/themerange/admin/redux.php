...
$opt_name = 'themerange_theme_options';
...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'themerange' ),
	'page_title'           => esc_html__( 'Theme Options', 'themerange' ),
	...
	'global_variable'      => 'themerange_theme_options',
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'General', 'themerange' ),
	'id'               => 'general-tab',
	'desc'             => '',
	'icon'             => 'el el-home',
...
Redux::setSection( $opt_name, array(
	...
	'desc'             => '',
	'icon'             => 'el el-cog',
	'fields'           => $option_fields['logo']
) );

/*** Header Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Header', 'themerange' ),
	'id'               => 'header-tab',
	'desc'             => '',
	'icon'             => 'el el-lines',
...
/*** Header Sidebar Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Header Sidebar', 'themerange' ),
	'id'               => 'header-sidebar-tab',
	'desc'             => '',
	'icon'             => 'el el-lines',
	'fields'           => $option_fields['header_sidebar']
) );

/*** Banner Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Banner', 'themerange' ),
	'id'               => 'banner-tab',
	'desc'             => '',
	'icon'             => 'el el-photo',
	'fields'           => $option_fields['banner']
) );

/*** Footer Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Footer', 'themerange' ),
	'id'               => 'footer-tab',
	'desc'             => '',
	'icon'             => 'el el-lines',
...
/*** Slug Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'CPT Slug', 'themerange' ),
	'id'               => 'cpt-slug-tab',
	'desc'             => '',
	'icon'             => 'el el-link',
	'fields'           => $option_fields['cpt_slug']
) );

/*** WooCommerce Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'WooCommerce', 'themerange' ),
	'id'               => 'woocommerce-tab',
	'desc'             => '',
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Shop/Product Category', 'themerange' ),
...
/*** Product Details Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Product Details', 'themerange' ),
...
/*** Custom Code Tab ***/
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Custom Code', 'themerange' ),
	'id'               => 'custom-code-tab',
	'desc'             => '',
	'icon'             => 'el el-edit',
