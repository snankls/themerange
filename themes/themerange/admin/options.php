...
$option_fields['banner'] = array(
	...
	array(
		'id'       => 'section-services',
		'type'     => 'section',
		'title'    => esc_html__( 'Services Details', 'themerange' ),
		'subtitle' => '',
		'indent'   => false
	),
	array(
		'id'       => 'tr_enable_services_banner',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable/Disable Banner', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
	...
	array(
		...
		'options'  => $breadcrumb_layout_options,
		'default'  => 'v1',
		'required'	=> array( 'tr_enable_services_banner', 'equals', true ),
	),
	array(
		'id'       => 'tr_services_background_image',
		'type'     => 'media',
		'url'      => true,
	...
	array(
		'id'       => 'tr_services_title',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable Services Banner Title', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
		'required'	=> array( 'tr_enable_services_banner', 'equals', true ),
	),
	array(
		'id'       => 'tr_services_custom_name',
		'type'     => 'text',
		'title'    => esc_html__( 'Services Banner Title', 'themerange' ),
		'desc'     => '',
		'default'  => '',
		'required'	=> array( 'tr_services_title', 'equals', '1' ),
	),
	array(
		'id'       => 'tr_enable_services_breadcrumb',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable Services Breadcrumbs', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
		'required'	=> array( 'tr_enable_services_banner', 'equals', true ),
	),
	...
	array(
		'id'       => 'section-classes',
		'type'     => 'section',
		'title'    => esc_html__( 'Classes Details', 'themerange' ),
		'subtitle' => '',
		'indent'   => false
	),
	array(
		'id'       => 'tr_enable_classes_banner',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable/Disable Banner', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
	...
	array(
		...
		'options'  => $breadcrumb_layout_options,
		'default'  => 'v1',
		'required'	=> array( 'tr_enable_classes_banner', 'equals', true ),
	),
	array(
		'id'       => 'tr_classes_background_image',
		'type'     => 'media',
		'url'      => true,
		'title'    => esc_html__( 'Breadcrumbs Background Image', 'themerange' ),
		'desc'     => '',
	...
	array(
		'id'       => 'tr_classes_title',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable Classes Banner Title', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
		'required'	=> array( 'tr_enable_classes_banner', 'equals', true ),
	),
	array(
		'id'       => 'tr_classes_custom_name',
		'type'     => 'text',
		'title'    => esc_html__( 'Classes Banner Title', 'themerange' ),
		'desc'     => '',
		'default'  => '',
		'required'	=> array( 'tr_classes_title', 'equals', '1' ),
	),
	array(
		'id'       => 'tr_enable_classes_breadcrumb',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable Classes Breadcrumbs', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
		'required'	=> array( 'tr_enable_classes_banner', 'equals', true ),
	),
	...
	array(
		'id'       => 'section-team',
		'type'     => 'section',
		'title'    => esc_html__( 'Team Details', 'themerange' ),
		'subtitle' => '',
		'indent'   => false
	),
	array(
		'id'       => 'tr_enable_team_banner',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable/Disable Banner', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
	...
	array(
		...
		'options'  => $breadcrumb_layout_options,
		'default'  => 'v1',
		'required'	=> array( 'tr_enable_team_banner', 'equals', true ),
	),
	array(
		'id'       => 'tr_team_background_image',
		'type'     => 'media',
		'url'      => true,
		'title'    => esc_html__( 'Breadcrumbs Background Image', 'themerange' ),
		'desc'     => '',
	...
	array(
		'id'       => 'tr_team_title',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable Team Banner Title', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
		'required'	=> array( 'tr_enable_team_banner', 'equals', true ),
	),
	array(
		'id'       => 'tr_team_custom_name',
		'type'     => 'text',
		'title'    => esc_html__( 'Team Banner Title', 'themerange' ),
		'subtitle' => '',
		'desc'     => '',
		'default'  => '',
		'required'	=> array( 'tr_team_title', 'equals', '1' ),
	),
	array(
		'id'       => 'tr_enable_team_breadcrumb',
		'type'     => 'switch',
		'title'    => esc_html__( 'Enable Team Breadcrumbs', 'themerange' ),
		'subtitle' => '',
		'default'  => true,
		'required'	=> array( 'tr_enable_team_banner', 'equals', true ),
	),
